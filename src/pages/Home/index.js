...
const Page = () => {
	const { data } = useData();
	const byDateUp = data?.events.sort((evtA, evtB) =>
		/* renvoie un tableau trié qui compare année puis mois puis jour du plus récent au ancien
		ex: 2023-05-12 > 2022-11-25 > 2021-03-13  */
